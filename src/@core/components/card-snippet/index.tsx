...
const CardSnippet = (props: CardSnippetProps) => {
  ...
  const codeToCopy = () => {
    if (code.tsx !== null && tabValue === 'tsx') {
      return (code.tsx as { props: { children: { props: { children: string } } } }).props.children.props.children
    } else if (code.jsx !== null && tabValue === 'jsx') {
      return (code.jsx as { props: { children: { props: { children: string } } } }).props.children.props.children
    } else {
      return ''
    }
  }
