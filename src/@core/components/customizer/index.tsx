...
// Type for theme parameter in styled components
type ThemeParam = { theme: Theme }

const Toggler = styled(Box)<BoxProps>(({ theme }: ThemeParam) => ({
  right: 0,
  top: '50%',
  display: 'flex',
  cursor: 'pointer',
...
const Drawer = styled(MuiDrawer)<DrawerProps>(({ theme }: ThemeParam) => ({
  width: 400,
  zIndex: theme.zIndex.modal,
...
const CustomizerSpacing = styled('div')(({ theme }: ThemeParam) => ({
  padding: theme.spacing(5, 6)
}))

const ColorBox = styled(Box)<BoxProps>(({ theme }: ThemeParam) => ({
  width: 45,
  height: 45,
  cursor: 'pointer',
    ...
    <div className='customizer'>
      ...
      <Drawer open={open} hideBackdrop anchor='right' variant='persistent'>
        <Box
          ...
          sx={{
            position: 'relative',
            p: (theme: Theme) => theme.spacing(3.5, 5),
              ...
              <Box sx={{ display: 'flex' }}>
                <ColorBox
                  ...
                  sx={{
                    ...
                    ...(themeColor === 'primary'
                      ? { width: 53, height: 53, m: (theme: Theme) => theme.spacing(1.5, 0.75, 0) }
                      : {})
                  }}
                />
                <ColorBox
